...
namespace argos {
    ...
    public:
        ...
        CCI_FootBotState& operator=(const CCI_FootBotState& c_footbot_state)
        {
            ...
            if (this != &c_footbot_state) {
                ...
                m_bIsUsingWiFiSensor					= c_footbot_state.m_bIsUsingAccelerometerSensor;
                ...
                m_bIsUsingWiFiActuator			  = c_footbot_state.m_bIsUsingWiFiActuator;
        ...
        virtual inline const CCI_FootBotLedsActuator::TLedSettings& GetActuatedLedsColor()
        {
       ...
       inline virtual CCI_FootBotGripperSensor::EGripPhase GetGripPhase()
         ...
         *
         **/
        inline virtual void GetReceivedWiFiMessages(CCI_WiFiActuator::TMessageList& t_messages){
        	CHECK_IS_SENSOR_USED_HELPER(WIFI_SENSOR_XML_NAME, m_bIsUsingWiFiSensor, "GetReceivedWiFiMessages");
        	m_pcWiFiSensor->GetReceivedMessages(t_messages);
        }
        ...
        inline virtual void SendWiFiBroadcastMessage(const std::string& str_payload, Real f_delay = 0){
 			CHECK_IS_ACTUATOR_USED_HELPER(WIFI_ACTUATOR_XML_NAME, m_bIsUsingWiFiActuator, "SendWiFiBroadcastMessage");
 			m_strActuatedWiFiMessage = str_payload;
 			m_fWiFiDelay = f_delay;
        }
    ...
    protected:
        ...
        static const std::string WIFI_SENSOR_XML_NAME;
        ...
        std::string								m_strActuatedWiFiMessage;
        Real 									m_fWiFiDelay;
        ...
        static const std::string WIFI_ACTUATOR_XML_NAME;
