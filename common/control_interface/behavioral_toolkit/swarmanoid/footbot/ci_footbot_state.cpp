...
namespace argos {
    ...
    const std::string CCI_FootBotState::WIFI_SENSOR_XML_NAME          = "wifi_radio";
    ...
    const std::string CCI_FootBotState::WIFI_ACTUATOR_XML_NAME      		= "wifi_radio";
    ...
    void CCI_FootBotState::Init()
    {
        ...
        SENSOR_INIT_HELPER(WIFI_SENSOR_XML_NAME,           			CCI_WiFiSensor,         m_pcWiFiSensor,            m_bIsUsingWiFiSensor);
        ...
        ACTUATOR_INIT_HELPER(WIFI_ACTUATOR_XML_NAME,           		CCI_WiFiActuator,         			m_pcWiFiActuator,              	m_bIsUsingWiFiActuator);
    }
    ...
    void CCI_FootBotState::ApplyState()
    {
        ...
        if (m_bIsUsingWiFiActuator) {
        	m_pcWiFiActuator->BroadcastMessage(m_strActuatedWiFiMessage, m_fWiFiDelay);
        }
