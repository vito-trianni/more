...
namespace argos {
   ...
   void CQTOpenGLVisitor::Visit(CKumarMicroQuadrotorEntity& c_entity) {
      DrawElement(c_entity);
      m_cUserFunctions.Draw(c_entity);
   }
   ...
   void CQTOpenGLVisitor::DrawElement(CKumarMicroQuadrotorEntity& c_entity) {
      /* Draw rays */
      DrawRays(c_entity.GetControllableEntity());
      /* Perform standard rotation and translation */
      DrawPositionalEntity(c_entity.GetEmbodiedEntity());
      /* Render the object */
      m_cKumarMicroQuadrotorModel.Draw(c_entity);
   }
