...
#include <argos2/simulator/visualizations/qt-opengl/models/qtopengl_kumar_micro_quadrotor.h>
...
namespace argos {
   ...
   protected:
      ...
      virtual void DrawElement(CKumarMicroQuadrotorEntity& c_entity);
   ...
   protected:
      ...
      CQTOpenGLKumarMicroQuadrotor m_cKumarMicroQuadrotorModel;
