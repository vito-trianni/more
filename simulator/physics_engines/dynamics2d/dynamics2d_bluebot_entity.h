...
/**
 * @file <argos2/simulator/physics_engines/dynamics2d_bluebot_entity.h>
 *
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#ifndef DYNAMICS2D_BLUEBOT_ENTITY_H
#define DYNAMICS2D_BLUEBOT_ENTITY_H
...
namespace argos {
   ...
   class CDynamics2DBluebotEntity : public CDynamics2DEntity {

   public:

      CDynamics2DBluebotEntity(CDynamics2DEngine& c_engine,
                               CBluebotEntity& c_entity);
      virtual ~CDynamics2DBluebotEntity();
   ...
   private:
      ...
      CBluebotEntity& m_cBluebotEntity;
